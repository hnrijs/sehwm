...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,  XK_Left,        FUNC_DIR_SWAP,     NULL, 0 },
    { MODKEY|ShiftMask,  XK_Right,       FUNC_DIR_SWAP,     NULL, 1 },
    { MODKEY|ShiftMask,  XK_Up,          FUNC_DIR_SWAP,     NULL, 0 },
    { MODKEY|ShiftMask,  XK_Down,        FUNC_DIR_SWAP,     NULL, 1 },
